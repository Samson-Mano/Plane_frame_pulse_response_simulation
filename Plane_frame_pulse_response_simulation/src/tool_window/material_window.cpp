...
void material_window::render_window()
{
	...
	ImGui::TextColored(text_color, "Second moment of area: %.3f", selected_material_data.second_moment_of_area);
	...
	if (ImGui::CollapsingHeader("Create Material "))
	{
		...
		ImGui::InputDouble("Second moment of area", &new_material_second_moment_of_area, 0, 0, "%.3f");
		...
		if (ImGui::Button("Create Material"))
		{
			...
			new_material.second_moment_of_area = new_material_second_moment_of_area;
